    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telegram', models.CharField(blank=True, help_text='Аккаунт в Telegram', max_length=33, null=True, validators=[django.core.validators.MinLengthValidator(6, message='Длинна аккаунта в Tg минимум 5 символов.'), user.service.validate_starts_with], verbose_name='Telegram')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_date', models.DateField(default='По настоящее время.', help_text='Дата окончания работы', verbose_name='Дата окончания работы')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_date', models.DateField(default='По настоящее время.', help_text='Дата окончания', verbose_name='Дата окончания')),
